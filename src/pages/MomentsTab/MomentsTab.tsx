...
export default function MomentsTab() {
  ...
  return <div className="overview moments-overview">
    ...
    <StretchExplorer episodes={episodes} selectedKey={selected ? stretchKey(selected) : null} nearOne={nearOne} onNearOne={value => { setNearOne(value); setSelectedKey(null) }} onSelect={episode => { if (selectedKey === stretchKey(episode)) setSelectedKey(null); else selectStretch(episode) }} />
